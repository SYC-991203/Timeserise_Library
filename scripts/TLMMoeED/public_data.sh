...
models=("TLMMoeED") 
# models=("TimesNet" "TLMMoeED")

# 数据集列表
# datasets=("sub1" "sub3" )
datasets=("offair" "femprocess_v2")

# 数据集对应的 direction 参数 (根据新代码备注更新)
declare -A directions
directions=(
    ["offair"]="1,1,2,0,0"
    ["femprocess_v2"]="1,1,2,0,2"
    ["femprocess_v2"]="0,0,0,1,1"
)
...
moe_params=(
    ["offair"]='{"0": [5.0, -5.0], "1": [0.0, 0.0], "2": [5.0, -5.0]}'
    ["femprocess_v2"]='{"0": [0.0, 0.0], "1": [5.0, -5.0], "2": [5.0, -5.0]}'
...
do
    ...
    do
        ...
        do
            # 定义日志文件路径
            log_file="./logs/${model}_${dataset}_${pred_len}_${target}.log"
