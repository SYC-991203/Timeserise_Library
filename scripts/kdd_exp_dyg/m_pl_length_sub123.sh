...
# 模型列表
models=("TimesNet")
# models=("FEDformer" "Informer"\
#  "PatchTST" "Reformer" "Transformer" "iTransformer" "DLinear" "LightTS" "HalfRouterformer" "Pyraformer" "Autoformer" "Crossformer" "Directionformer")

# 数据集列表
# datasets=("sub2")
datasets=("sub3" "sub1" "sub2")
# 数据集对应的 direction 参数
    ...
    do
        ...
        do
            ...
            python -u run.py \
                ...
                --data_path "$data_path" \
                --model_id "${model_id}_${pred_len}_round2" \
                --model "$model" \
                --data DYG_base \
                --features M \
                --seq_len 96 \
