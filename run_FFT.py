...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./data/public', help='root path of the data file')
    ...
    parser.add_argument('--seg_len', type=int, default=12,
                    help='length of each patch segment (i.e., patch size P, also used as stride S by default)')
    ...
    parser.add_argument('--enc_out', type=int, default=5, help='encoder out size which equals to the target dim')
    ...
    parser.add_argument('--channel_independent', type=int, default=1,
                    help='CI or Not')
    parser.add_argument('--moe_logits_init', type=str, default='{}',
                    help='JSON string for MoE guidance init logits: {"group_id": [E0_logit, E1_logit], ...}')
