...
run_model(
    'TLMMoeED', 'DYG_data_3_sub1.csv', features='M', seq_len=96, label_len=48, pred_len=96, e_layers=2, 
    d_layers=1, factor=3, enc_in=5, dec_in=5, c_out=5, d_model=512, d_ff=512, top_k=5, \
          des='test', batch_size=256, itr=1, devices='0,1,2,3', target='zs',direction='1,1,2,0,0',
