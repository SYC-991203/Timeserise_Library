...
from layers.SelfAttention_Family import HalfRouterAttentionLayer
...
class scale_block(nn.Module):
    def __init__(self, configs, win_size, d_model, n_heads, d_ff, depth, dropout, \
        ...
        for i in range(depth):
            self.encode_layers.append(HalfRouterAttentionLayer(configs, seg_num, factor, d_model, n_heads, \
                                                             d_ff, dropout))
