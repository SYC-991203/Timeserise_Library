...
lambda_value = 1e-2
exp_itme = "ht_4" ## 修改这个就行了 就修改成项目_IMF个数 其他什么都不用改了
...
# spatial_att = spatial_att.t()
# spatial_att = spatial_att.cpu().detach().numpy()
...
filepath = "/home/qsmx/Data/Visualization.xlsx"
