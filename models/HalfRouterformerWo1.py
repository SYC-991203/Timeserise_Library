...
from layers.SelfAttention_Family import AttentionLayer, FullAttention, HalfRouterAttentionLayerWo1
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.decoder = Decoder(
            [
                DecoderLayer(
                    HalfRouterAttentionLayerWo1(configs, (self.pad_out_len // self.seg_len), configs.factor, configs.d_model, configs.n_heads,
